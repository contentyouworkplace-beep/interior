...
export default function InvoicesPage() {
  ...
  const handleMarkAsPaid = async (invoice: Invoice) => {
    try {
      const result = await invoiceService.updateInvoiceStatus(invoice.id, 'paid', 'paid')
              ...
              <Card key={invoice.id} className="hover:shadow-lg transition-shadow duration-200">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className={new Date(invoice.due_date) < new Date() && invoice.payment_status !== 'paid' ? 'text-red-600 font-medium' : ''}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Badge variant="outline" className={getPaymentStatusColor(invoice.payment_status)}>
                      {invoice.payment_status === 'unpaid' ? 'Unpaid' :
                       ...
                       invoice.payment_status === 'paid' ? 'Paid' : 'Refunded'}
                    </Badge>
                  </div>
                </CardContent>
                ...
                <div className="grid grid-cols-4 gap-2 p-4 pt-0">
                  <Button 
                    ...
                    onClick={() => toast.info("View dialog temporarily disabled")}
                  >
