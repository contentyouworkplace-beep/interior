...
interface CreateInvoiceDialogMinimalProps {
...
export function CreateInvoiceDialogMinimal({ children, onSuccess, open: controlledOpen, onOpenChange }: CreateInvoiceDialogMinimalProps) {
  ...
  const loadInitial = async () => {
    setLoading(true)
    try {
      const [settingsRes, clientsRes, invoiceNumberRes] = await Promise.all([
      ...
      // Settings loaded (terms no longer needed)
      ...
      if (invoiceNumberRes) {
        setFormData(prev => ({ ...prev, invoiceNumber: invoiceNumberRes }))
      }
