-- ==========================================
-- AUTHENTICATION ID FIX FOR INTERIOR DESIGNER CRM
-- ==========================================
...
BEGIN
    ...
    -- Create vendors table with user_id as UUID without foreign key constraint
    CREATE TABLE vendors (
        id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
        user_id UUID NOT NULL, -- No foreign key constraint to auth.users(id)
        name TEXT NOT NULL,
        contact_person TEXT,
        category TEXT,
        email TEXT,
...
-- ==========================================
-- INSERT DEMO DATA WITH AUTHENTICATION ID
-- ==========================================
...
BEGIN
    FOR table_record IN 
        ...
        WHERE schemaname = 'public'
    LOOP
        EXECUTE format('GRANT ALL PRIVILEGES ON TABLE public.%I TO public;', table_record.tablename);
        RAISE NOTICE 'Granted all privileges on table: % to public users', table_record.tablename;

        EXECUTE format('GRANT ALL PRIVILEGES ON TABLE public.%I TO anon;', table_record.tablename);
        RAISE NOTICE 'Granted all privileges on table: % to anon users', table_record.tablename;
    ...
    END LOOP;
    RAISE NOTICE '✅ All privileges granted on all tables for all user types!';
END $$;
...
DO $$
BEGIN
    RAISE NOTICE '✅ 5 demo vendors have been added for auth ID 4bdb74e7-7441-4ca0-9eb4-5ac3a73c22d6!';
END $$;
